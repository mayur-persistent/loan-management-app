...
(function() {
  ...
  function loadTradeoffAnalytics(profile, themeName, callback, errCallback) {
    taClient = new TA.TradeoffAnalytics({
      dilemmaServiceUrl: 'http://providentia.mybluemix.net/demo/dilemmas',
      analyticsEventsUrl: 'http://providentia.mybluemix.net/demo/dilemmas',
      metadata: {
  ...
  function loadProfile(profileName) {
    $.get('tradeoff/advanced/profiles/' + profileName, function(data) {
  ...
  function loadTheme(themeName) {
    $.get('tradeoff/advanced/themes/' + themeName + '.less', function(data) {
      $('#themeText').val(data);
    });
  }
